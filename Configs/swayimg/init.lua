...
--------------------------------------------------------------------------------
swayimg.imagelist.order = "mtime"        -- list order
swayimg.imagelist.reverse = true          -- reverse order
...
swayimg.text.font = "Google Sans Flex"            -- font name
swayimg.text.size = 20                     -- font size in pixels
swayimg.text.spacing = 0                   -- line spacing
swayimg.text.padding = 20                  -- padding from window edge
